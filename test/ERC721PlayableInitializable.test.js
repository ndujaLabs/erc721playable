...
describe("ERC721PlayableInitializable", function () {
  ...
  beforeEach(async function () {
    erc721Mock = await deployContract('ERC721InitializableMock', "Some NFT", "SNFT")
  })

  it("should mint token and set up attributes", async function () {
